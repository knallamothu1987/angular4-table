...
@Component({
    selector: 'app-angular4-table-filter',
    templateUrl: './angular4-table-filter.component.html',
})


export class Angular4TableFilterComponent implements OnInit {
    @Input() tableColumns: Array<string> = [];
    @Input() filterIconClass = '';
