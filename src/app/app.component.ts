...
export class AppComponent {
  ...
  public total = 0;
  public customersColumns: Array<string> = ["URL", "name", "address", "address line 2", "outcode", "postcode", "rating", "type_of_food"];
  public defaultColumns: Array<string> = ['name', 'address'];
